...
import { ShowMe } from "./Button"; // Import the ShowMe component
...
function KeyPadComponent(props){
    ...
    const ClickHandle = (e) => {
        ...
        // calculation for square number
 
else if (e.target.value === "square") {
    setText(Math.pow(parseFloat(text1), 2)); // Calculate square of the number
  } else
  {
